<body>
		...
		<div class="fluid-container">
			<nav class="navbar navbar-default">
				<div class="navbar-header">
					...
					<a class="navbar-brand" href="{{url('/')}}"><img src="{{url('pubic/images/knoll2.jpg')}}" height="40" width="100"></a> 
				</div>
				...
				<div id="navbar" class="navbar-collapse collapse">
					<ul class="nav navbar-nav navbar-right">
						...
						<a  href="{{url('/')}}" class="external"><span>Home</span></a></li>
						<li class="{{Request::is('about')?'active':''}}"><a href="about" class="external" ><span>About Us</span></a></li>
						
						
						<li class="{{Request::is('vision')?'active':''}}"><a href="vision" class="external"><span>Vision</span></a></li>
    ...
    <a href="{{url('brand')}}"  class="external">By Brand</a>
  	<a href="{{url('category')}}"  class="external">By Categories</a>
						...
						<li class="{{Request::is('faq')?'active':''}}"><a href="faq" class="external"><span>Faq</span></a></li>
						<li class="{{Request::is('media')?'active':''}}"><a href="media" class="external"><span>Media</span></a></li>

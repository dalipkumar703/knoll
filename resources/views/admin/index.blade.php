 ...
 <div class="col-md-offset-3 col-md-6 collapse" style="background-color: #ecffee;" id="demo">
  ...
  <h2 ><center>Add New </center></h2>
   ...
   <div class="form-group{{ $errors->has('productname') ? ' has-error' : '' }}">
    ...
    <input class="form-control" id="name" name="productname" type="text">
   ...
   <div class="form-group{{ $errors->has('composition') ? ' has-error' : '' }}">
    ...
    <input class="form-control" id="brand" name="composition" type="text">
...
<span class="help-block">{{ $errors->first('file') }}</span>
   ...
   <div class="form-group{{ $errors->has('division') ? ' has-error' : '' }}">
    ...
    <input class="form-control" id="price" name="division" type="text">
...
<span class="help-block">{{ $errors->first('file1') }}</span>
 ...
 <div class="row" >
  ...
  <tr ng-repeat="x in genericData">
    ...
    <td><a href="{{url('admin/product/update/<% x.id %>')}}">Edit</a></td>
<td><a href="{{url('admin/product/delete/<% x.id %>')}}">Delete</a></td>
...
<div class="col-md-12 text-center">
  ...
  <tr ng-repeat="brand in brandData">
    ...
    <td><a href="{{url('admin/product/update/<% brand.id %>')}}">Edit</a></td>
<td><a href="{{url('admin/product/delete/<% brand.id %>')}}">Delete</a></td>
